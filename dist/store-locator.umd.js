(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('leaflet'), require('leaflet.markercluster'), require('leaflet.locatecontrol'), require('@raruto/leaflet-gesture-handling'), require('leaflet/dist/leaflet.css'), require('leaflet.markercluster/dist/MarkerCluster.css'), require('leaflet.markercluster/dist/MarkerCluster.Default.css'), require('leaflet.locatecontrol/dist/L.Control.Locate.css'), require('@raruto/leaflet-gesture-handling/dist/leaflet-gesture-handling.css')) :
  typeof define === 'function' && define.amd ? define(['leaflet', 'leaflet.markercluster', 'leaflet.locatecontrol', '@raruto/leaflet-gesture-handling', 'leaflet/dist/leaflet.css', 'leaflet.markercluster/dist/MarkerCluster.css', 'leaflet.markercluster/dist/MarkerCluster.Default.css', 'leaflet.locatecontrol/dist/L.Control.Locate.css', '@raruto/leaflet-gesture-handling/dist/leaflet-gesture-handling.css'], factory) :
