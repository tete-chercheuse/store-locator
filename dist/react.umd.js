(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('leaflet'), require('leaflet-gesture-handling'), require('leaflet.markercluster'), require('leaflet.locatecontrol'), require('leaflet/dist/leaflet.css'), require('leaflet-gesture-handling/dist/leaflet-gesture-handling.css'), require('leaflet.markercluster/dist/MarkerCluster.css'), require('leaflet.markercluster/dist/MarkerCluster.Default.css'), require('leaflet.locatecontrol/dist/L.Control.Locate.css')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', 'leaflet', 'leaflet-gesture-handling', 'leaflet.markercluster', 'leaflet.locatecontrol', 'leaflet/dist/leaflet.css', 'leaflet-gesture-handling/dist/leaflet-gesture-handling.css', 'leaflet.markercluster/dist/MarkerCluster.css', 'leaflet.markercluster/dist/MarkerCluster.Default.css', 'leaflet.locatecontrol/dist/L.Control.Locate.css'], factory) :
  (global = global || self, factory(global.StoreLocatorReact = {}, global.React, global.L));
})(this, (function (exports, react, L) {
