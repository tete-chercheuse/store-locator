...
import type { ExpressionSpecification, GeolocateControlOptions, MapOptions as MapLibreMapOptions, MarkerOptions, PaddingOptions, PopupOptions, StyleSpecification } from 'maplibre-gl';
...
export type StoreLocatorCoordinateStore<P extends StoreLocatorProperties = StoreLocatorProperties> = P & ({
    lat: StoreLocatorCoordinateValue;
    lng: StoreLocatorCoordinateValue;
} | {
    lat: StoreLocatorCoordinateValue;
    lon: StoreLocatorCoordinateValue;
} | {
    lat: StoreLocatorCoordinateValue;
    longitude: StoreLocatorCoordinateValue;
} | {
    latitude: StoreLocatorCoordinateValue;
    lng: StoreLocatorCoordinateValue;
} | {
    latitude: StoreLocatorCoordinateValue;
    lon: StoreLocatorCoordinateValue;
...
export type StoreLocatorStoresInput<P extends StoreLocatorProperties = StoreLocatorProperties> = StoreLocatorFeatureCollection<P> | StoreLocatorFeature<P>[] | StoreLocatorCoordinateStore<P>[];
/**
...
export type StoreLocatorIconValue = string | HTMLElement | StoreLocatorIconOptions | null;
export type StoreLocatorIconFactory<P extends StoreLocatorProperties = StoreLocatorProperties> = StoreLocatorIconValue | ((feature: StoreLocatorFeature<P>) => StoreLocatorIconValue | undefined);
...
export type StoreLocatorPopupValue = StoreLocatorPopupContent | StoreLocatorPopupOptions | null;
export type StoreLocatorPopupFactory<P extends StoreLocatorProperties = StoreLocatorProperties> = StoreLocatorPopupValue | ((feature: StoreLocatorFeature<P>) => StoreLocatorPopupValue | undefined);
