...
export type StoreLocatorPopupFactory<P extends StoreLocatorProperties = StoreLocatorProperties> = string | L.Popup | null | ((feature: StoreLocatorFeature<P>) => string | L.Popup | null | undefined);
export type StoreLocatorIconFactory<P extends StoreLocatorProperties = StoreLocatorProperties> = L.Icon | L.DivIcon | null | ((feature: StoreLocatorFeature<P>) => L.Icon | L.DivIcon | null | undefined);
